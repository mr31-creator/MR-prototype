import svgPaths from "@/imports/5PollNotification/svg-5dw22vuu05";
import img5PollNotification from "@/imports/5PollNotification/834ed1d58b938a7b17b67e5717abae140dbb3da9.png";

function Time() {
  return (
    <div className="content-stretch flex h-[22px] items-center justify-center pt-[2px] relative shrink-0 w-[84px]" data-name="Time">
      <p className="[word-break:break-word] font-['SF_Pro',sans-serif] font-[590] leading-[22px] relative shrink-0 text-[17px] text-center text-white whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        17:41
      </p>
    </div>
  );
...
function StatusBarIPhone() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex items-center justify-between left-1/2 pb-[19px] pt-[21px] px-[16px] top-0 w-full" data-name="Status bar - iPhone">
      <Time />
      <Levels />
    </div>
  );
    ...
    <div className="relative shrink-0 size-[39px]" data-name="Trip up logo">
      <svg className="absolute block inset-0 size-full" fill="none" height="39" preserveAspectRatio="none" viewBox="0 0 39 39" width="39">
        <g id="Trip up logo">
          ...
          <g id="Vector">
            <path d={svgPaths.p31169580} stroke="url(#paint0_linear_lock)" strokeLinecap="round" strokeWidth="2.76712" />
            <path d={svgPaths.p31169580} stroke="url(#paint1_linear_lock)" strokeLinecap="round" strokeOpacity="0.4" strokeWidth="2.76712" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_lock" x1="28.7083" x2="11.1343" y1="14.6054" y2="26.4017">
            <stop stopColor="#FFCF89" />
            <stop offset="0.5" stopColor="#D8DDFF" />
            <stop offset="1" stopColor="#8293FF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_lock" x1="13.5417" x2="26.3009" y1="11.5961" y2="27.2443">
...
function NotificationContent() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col items-start min-w-px not-italic overflow-clip relative text-white" data-name="Notification Content">
      <TitleTime />
      <p className="font-['SF_Pro',sans-serif] font-normal leading-[18px] opacity-80 relative shrink-0 text-[13px] text-left tracking-[-0.078px] w-full whitespace-pre-wrap">
...
export default function LockScreen({ onOpen }: { onOpen: () => void }) {
  return (
