import svgPaths from "./svg-gr5y3ku8x1";
...
export default function Card() {
  return (
    <div className="bg-white border-[#e1dfe0] border-[1.2px] border-solid content-stretch flex items-center justify-between pl-[12px] pr-[16px] py-[12px] relative rounded-[24px] size-full" data-name="card">
      <Frame />
      <Checkbox />
    </div>
  );
