import svgPaths from "./svg-7qedj4bou3";
...
function AvatarStack() {
  return (
    <div className="content-stretch flex items-center opacity-0 pointer-events-none relative shrink-0" data-name="avatar stack">
...
function OptionCard() {
  return (
    <div className="border border-[#e1dfe0] border-solid content-stretch flex items-center justify-between overflow-clip pl-[6px] pr-[12px] py-[6px] relative rounded-[12px] shrink-0 w-full" data-name="option card">
      <div className="absolute bg-[#f0f2ff] h-[55px] left-[-1px] opacity-0 top-[-1px] w-[126px]" data-name="Vote fill" />
      <OptionInfo />
      <VoteStack />
    </div>
  );
...
function OptionCard1() {
  return (
    <div className="border border-[#e1dfe0] border-solid content-stretch flex items-center justify-between overflow-clip pl-[6px] pr-[12px] py-[6px] relative rounded-[12px] shrink-0 w-[319px]" data-name="option card">
      <div className="absolute bg-[#eaf9f1] h-[55px] left-[-1px] opacity-0 top-[-1px] w-[126px]" data-name="Vote fill" />
      <OptionInfo1 />
      <VoteStack1 />
    </div>
  );
...
function AvatarStack2() {
  return (
    <div className="content-stretch flex items-center pointer-events-none relative shrink-0" data-name="avatar stack">
      ...
      <div className="opacity-0 relative rounded-[45.029px] shrink-0 size-[28px]" data-name="avatar">
        <div className="absolute inset-0 overflow-hidden rounded-[45.029px]">
...
function OptionCard2() {
  return (
    <div className="border border-[#e1dfe0] border-solid content-stretch flex items-center justify-between overflow-clip pl-[6px] pr-[12px] py-[6px] relative rounded-[12px] shrink-0 w-[319px]" data-name="option card">
      <div className="absolute bg-[#fff6e9] h-[55px] left-[-1px] opacity-0 top-[-1px] w-[81px]" data-name="Vote fill" />
      <OptionInfo2 />
      <VoteStack2 />
    </div>
  );
