import svgPaths from "./svg-7owqzelnkr";
...
function TitleTime() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="Title + Time">
      ...
      <p className="font-['SF_Pro_Text:Regular',sans-serif] leading-[18px] mix-blend-overlay relative shrink-0 text-[13px] text-right tracking-[-0.078px] whitespace-nowrap">now</p>
    </div>
  );
}
...
export default function Notification() {
  return (
    <div className="bg-[rgba(0,0,0,0.2)] relative rounded-[16px] size-full" data-name="Notification">
