...
export default function OptionCardDefault() {
  return (
    <div className="border border-[#e1dfe0] border-solid content-stretch flex items-center justify-between overflow-clip pl-[6px] pr-[12px] py-[6px] relative rounded-[12px] size-full" data-name="option card default">
