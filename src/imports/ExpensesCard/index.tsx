import svgPaths from "./svg-465wuylxmw";
...
function Send() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="send">
      <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
        <g id="send">
          <path d={svgPaths.p3cd93700} fill="white" id="Subtract" />
        </g>
      </svg>
    </div>
  );
...
function BalanceRow() {
  return (
    <div className="content-stretch flex gap-[64px] items-center relative shrink-0 w-full" data-name="balance row">
      <Description />
      <Button1 />
    </div>
  );
