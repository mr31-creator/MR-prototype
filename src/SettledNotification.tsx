...
import svgPaths from "@/imports/Notification-4/svg-utgnpa8s11";
    ...
    <div className="relative shrink-0 size-[39px]" data-name="Trip up logo">
      <svg className="absolute block inset-0 size-full" fill="none" height="39" preserveAspectRatio="none" viewBox="0 0 39 39" width="39">
        <g id="Trip up logo">
          ...
          <g id="Vector">
            <path d={svgPaths.p31169580} stroke="url(#paint0_linear_settled_inapp)" strokeLinecap="round" strokeWidth="2.76712" />
            <path d={svgPaths.p31169580} stroke="url(#paint1_linear_settled_inapp)" strokeLinecap="round" strokeOpacity="0.4" strokeWidth="2.76712" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_settled_inapp" x1="28.7083" x2="11.1343" y1="14.6054" y2="26.4017">
            <stop stopColor="#FFCF89" />
            <stop offset="0.5" stopColor="#D8DDFF" />
            <stop offset="1" stopColor="#8293FF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_settled_inapp" x1="13.5417" x2="26.3009" y1="11.5961" y2="27.2443">
...
// in-app banner for the settled trip: slides down from the top edge and rests 30px below it
export default function SettledNotification({ onDismiss, onOpen, open }: { onDismiss: () => void; onOpen: () => void; open: boolean }) {
  ...
  return (
    <div className={`-translate-x-1/2 fixed left-1/2 max-w-[355px] top-[30px] w-[calc(100%_-_24px)] z-40 ${open ? "" : "pointer-events-none"}`} data-name="notification band">
      <button
        className="bg-[rgba(0,0,0,0.1)] relative rounded-[16px] touch-none w-full"
